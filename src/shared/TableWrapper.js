...
function TableWrapper(props) {
  const { header = 'Header', loading = false } = props
  return (
    <div className='h-full w-full relative bg-white border-gray-200 rounded-lg dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700'>
      ...
      <div className=' font-public-sans text-[12px] font-medium leading-6 text-left sticky top-0 h-[56px] px-6 py-3 flex gap-3 items-center text-sm bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 '>
        {header}
        { loading &&
      ...
      {/* Scrollable table */}
      <div className=''> {/* Set a height for the scrollable area */}
        <Table {...props} />
      </div>
    </div>
