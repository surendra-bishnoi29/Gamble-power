...
function Values() {
  ...
  return (
    <div className=' bg-[#fafbfc] bg-transparent rounded-2xl flex flex-col p-7 justify-center items-center'>
        ...
        {ValueList.map((item)=>{
                return <ValueCard value={item.value} icon={item.icon} description={item.description}  />
        })}
