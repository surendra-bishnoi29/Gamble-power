...
const Footer = () => {
    ...
    return (
        <footer className=" relative bg-gray-900 bg-opacity-40 h-[380px] text-gray-300 text-sm  ">
            <img className=' absolute w-full -z-10 h-[380px]' src='footer.jpg' />
            <div className="container mx-auto px-4 pt-12 flex justify-center items-center">
                <div className="grid grid-cols-1 w-[1000px] md:grid-cols-3 gap-8 justify-items-center items-center ">
                    ...
                    <div className="col-span-1">
                        ...
                        <p className="text-sm mb-4">
                            Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat modo typi, qui nunc nobis videntur parum clari, fiant sollemnes in futurum delenit augue duis dolore te feugait.
                        </p>
                    ...
                    <div className="col-span-1">
                        ...
                        <p className="text-sm mb-6">Get latest updates and offers.</p>
