            ...
            <div className=' flex justify-center gap-96'>
                ...
                <div className=' flex gap-10 items-center'>
                    ...
                    <div className=' flex gap-1 items-center'>
                        ...
                        <div className='  '>
                            <div className=' text-[13px]'>info@giving.com</div>
                    ...
                    <div className=' flex gap-1 items-center'>
                        ...
                        <div className='  '>
                            <div className=' text-[13px] tracking-wide'>7424864829</div>
                            <div className=' text-[8px]'>
                                9:00 A.M. - 5:00 P.M.
                            </div>
                        </div>
                    ...
                    <div>
                        <span className=' bg-green-600 py-2 px-4 hover:rounded-full cursor-pointer text-white'>
                            Donate
                        </span>
                    </div>
                </div>
